...
//                waveCheck = false;
        ...
        private WaveDetails genNextWave() {
            var nextWaveDetails = new WaveDetails(currentWaveDetails.buildTime, null, 0, Mathf.Max(currentWaveDetails.spawnDelay - 0.01f, 0.25f), currentWaveDetails.waveNr + 1, currentWaveDetails.waveScore + Mathf.Pow(4, (currentWaveDetails.waveNr + 1)/5f));
            //Todo balancing
